...
set(SDK_ROOT ${CMAKE_CURRENT_LIST_DIR}/cs2kz-metamod/hl2sdk-cs2 CACHE STRING "SDK root directory")
...
set(MM_ROOT ${CMAKE_CURRENT_LIST_DIR}/cs2kz-metamod/metamod-source CACHE STRING "Metamod root directory")
...
if(WIN32)
	...
	set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -mfpmath=sse -msse -fno-strict-aliasing -m64 -std=c++23")
...
if(WIN32)
	file(GLOB SHARED_LIBS
		...
		"${SDK_ROOT}/lib/public/win64/tier0.lib"
	)
else()
	file(GLOB SHARED_LIBS
		...
		"${SDK_ROOT}/lib/linux64/libtier0.so"
	)
endif()
